...
////$json = file_get_contents("localhost:8080/GP_WebService/view_Profile.php?uid=$uid&lid=$lid"); http://4gp.comli.com

$obj  = json_decode($json, true); 
//$uid = 5000;
//$lid = 5000;
////​
//$json = file_get_contents("http://4gp.comli.com/GP_WebService/view_Profile.php?uid=$uid&lid=$lid");

...
$(".addmore").on('click',function(){
    ...
    data +="<td><input class='form-control' type='text' id='countryname_"+i+"' name='medicin_name[]'/></td> <td><input class='form-control' type='text' id='country_no_"+i+"' name='repeat_no[]'/></td></tr>";
	$('table').append(data);
	row = i ;
